 ...
 * 
 * 
 * @author hub CreateHandler
 */
public class HX3_GCGGTZD extends AbstractHandler implements
	...
	protected void initWizardModel(ExecutionEvent executionevent) {
		...
		if (executionevent != null) {
			...
			if (executionevent.getParameters().containsKey("pasteRelation")) {
				String s = "HX3_gcggtz";
				// = (String) executionevent.getParameters().get(
				// "pasteRelation");
				if (s != null) {
					String as[] = null;
					as = s.split(",");
